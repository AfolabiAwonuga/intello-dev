...
export default function AgentBlocks(props: { imageUrl: string }) {
  ...
  return (
    <>
      {/* MAIN NAV */}
      <nav className="rounded-[10px] ml-[8px] flex items-center">
      ...
      <div className="grid grid-cols-2 mt-2">
        ...
        <div className="flex flex-col rounded-[10px]">
          <div className="grid grid-rows-[3px_min-content_1fr] h-full mb-[50px] mx-[10px] rounded-sm gap-7 bg-gray-400/30 border border-black">
            {response ? (
            ...
            {response && (
              ...
              >
                ...
                {/* {topic && (
                  <Badge className="m-2 inline-flex self-start">{topic}</Badge>
                )} */}
              </div>
            )}
            <div
        ...
        {/* SOL AGENT BLOCK */}
        <div className="rounded-[10px] mb-[50px] mr-[10px]">
